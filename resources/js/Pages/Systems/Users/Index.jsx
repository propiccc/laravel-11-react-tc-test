...
const Index = () => {
    ...
    const getDataTable = (url = null) => {
        var url = url == null ? '/api/v1/user?' + `limit=${Paginate.limit}&search=${Paginate.search}` : '/api' + url.split('/api')[1] + `&limit=${Paginate.limit}&search=${Paginate.search}`;
        setBlock(true);
    ...
    const getDataEdit = async (uuid) => {
        ...
        try {
            const res = await axios.post(`/api/v1/user/${uuid}/show`);
    ...
    const DeleteData = (uuid) => {
        ...
        setFormToggle(false);
        setDataEdit(null);
        var url = `/api/v1/user/${uuid}/delete`
    ...
    return (
        <>
            ...
            <div className="flex justify-between border-b-[1px] border-gray-400 bg-neutral-100 text-black rounded-t-md px-3 p-2 items-center">
                <span className="font-semibold">Users Data</span>
                                ...
                                <table
                                    ...
                                    <thead
                                        ...
                                        <tr className='sticky top-0'>
                                            ...
                                            <th scope="col" className="whitespace-nowrap py-2 text-start">Username</th>
                                            <th scope="col" className="whitespace-nowrap py-2 text-start">Email</th>
                                            ...
                                            Data?.data?.map((item, index) => (
                                                <>
                                                    <tr key={index} className="border-b border-gray-200">
                                                        ...
                                                        <td className="whitespace-pre-line py-2 ">{item.name}</td>
                                                        <td className="whitespace-pre-line py-2 ">{item.email}</td>
