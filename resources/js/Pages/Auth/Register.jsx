        ...
        <div className={`h-screen flex items-center justify-center`}>
            ...
            <div className=" bg-white flex p-5 rounded-lg shadow-xl">
                ...
                <div className="w-1/2 flex flex-col p-5">
                    <span className='text-xl text-center font-semibold text-black'>Register Your Account Here!</span>
                    <form onSubmit={Login} className="flex flex-col text-start mt-5">
                        <div className="flex flex-col mb-10">
                            <input type="text" id="username" className='focus:outline-none focus:border-b-blue-500 bg-transparent border-b-[2px] p-4 text-black transition-colors duration-200 text-lg placeholder-gray-400' placeholder='Username' autoComplete='off' name='username' onChange={HandleChange} />
                            {Errors?.username ? (
                        ...
                        <div className="flex flex-col mb-10">
                            <input type="text" id="email" className='focus:outline-none focus:border-b-blue-500 bg-transparent border-b-[2px] p-4 text-black transition-colors duration-200 text-lg placeholder-gray-400' placeholder='Email' autoComplete='off' name='email' onChange={HandleChange} />
                            {Errors?.email ? (
                                <div className="text-red-700 px-2 mt-2">
                        ...
                        <div className="flex flex-col mb-10">
                            <input type="password" id="password_confirmation" className='focus:outline-none focus:border-b-blue-500 bg-transparent border-b-[2px] p-4 text-black transition-colors duration-200 text-lg placeholder-gray-400' placeholder='Password Conformation' autoComplete='off' name='password_confirmation' onChange={HandleChange} />
                            {Errors?.password ? (
                                <div className="text-red-700 px-2 mt-2">
                                    {Errors?.password?.map((item, index) => (
                                        <li key={index} className='text-sm'>{item}</li>
                        ...
                        <div className="flex justify-center w-fu ll mt-2 mb-5">
                            <button className='bg-blue-700 hover:bg-blue-600 transition-all duration-200 text-white font-semibold shadow-white w-full p-2 rounded-lg active:scale-95' type='submit' disabled={loading}>{loading ? (<ComLoading />) : "Register"}</button>
                        </div>
